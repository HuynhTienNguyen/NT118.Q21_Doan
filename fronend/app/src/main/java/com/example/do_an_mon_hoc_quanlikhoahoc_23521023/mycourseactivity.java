...
public class mycourseactivity extends AppCompatActivity {
    ...
    private void showSidebarMenu() {
        ...
        menuProfile.setOnClickListener(v -> {
            startActivity(new Intent(mycourseactivity.this, ProfileActivity.class));
            dialog.dismiss();
        });

        menuCourses.setOnClickListener(v -> {
            startActivity(new Intent(mycourseactivity.this, CourseListActivity.class));
            dialog.dismiss();
        });

        menuMyCourses.setOnClickListener(v -> {
            startActivity(new Intent(mycourseactivity.this, mycourseactivity.class));
            dialog.dismiss();
        });
